...
func ClientFromArgoSecret(secret *v1.Secret) (client.Client, error) {
	restConfig, err := RestConfigFromArgoSecret(secret)
	if err != nil {
		return nil, err
	}
...
func ClientsetFromArgoSecret(secret *v1.Secret) (*kubernetes.Clientset, error) {
	restConfig, err := RestConfigFromArgoSecret(secret)
	if err != nil {
		return nil, err
	}
...
func RestConfigFromArgoSecret(secret *v1.Secret) (*rest.Config, error) {
