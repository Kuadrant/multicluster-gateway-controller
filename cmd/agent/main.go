...
func main() {
	...
	if err = (&ingress.Ingress{
		...
		DefaultCtrlNS:         defaultCtrlNS,
		DefaultCertProvider:   defaultCertProvider,
		ControlPlaneSecretRef: client.ObjectKey{Namespace: controlPlaneConfigSecretNamespace, Name: controlPlaneConfigSecretName},
